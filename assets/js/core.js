...
/* ---------- REVEAL ---------- */
function reveal(){
  /* Static fallback: no IntersectionObserver, reduced motion, or ?static in the URL */
...
if (window.location.pathname.includes("marketing.html")) {
    ...
    window.addEventListener("scroll", () => {
        ...
        navLinks.forEach(link => {
            ...
            if (
                (current === "team" && href.includes("#team")) ||
                (current !== "team" && href === "marketing.html")
            ) {
